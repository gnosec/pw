...
describe('ChangeMasterPasswordCommand', () => {
  ...
  const command = new ChangeMasterPasswordCommand(masterPasswordConfig, validationService, promptService, passwordSafeService);

  beforeEach(() => {
      validationService.validateMasterPassword = jasmine.createSpy().and.returnValue([]);
  })

...
const PasswordSafeService = require('./domain/password-safe.service');
...
const createCommand = new CreateCommand(applicationConfig.masterPassword, passwordSafeService);

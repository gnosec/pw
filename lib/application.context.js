...
const validationService = new ValidationService(applicationConfig.editor);
const color = new Color(applicationConfig.editor.color);
const clipboardService = new ClipboardService();

const shellCommands = [
  new GenerateCommand(applicationConfig, validationService, passwordService, clipboardService),

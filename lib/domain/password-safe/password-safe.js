...
const _checkKey = input => notNullOrEmptyString(input, 'key must not be null or empty');
const _checkValue = input => notNullOrEmptyString(input, 'value must not be null or empty');

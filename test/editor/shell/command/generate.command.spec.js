...
describe('GenerateCommand', () => {
    ...
    describe('validate()', () => {
        ...
        it('should not validate key when absent', () => {
            ...
            expect(validationService.validateKey).toHaveBeenCalledTimes(0);
            expect(validationService.getConflicts).toHaveBeenCalledTimes(0);
        })
    ...
    describe('execute()', () => {
        ...
        it('should set a key to a value when a key is provided', () => {
            const data = {},
                key = 'key',
                value = 'value',
                options = {};
        ...
        it('should not set a key to a value when a key is not provided', () => {
            const data = {},
                key = undefined,
                value = 'value',
                options = {};
        ...
        it('should copy generated value to clipboard', () => {
            const data = {},
                key = 'key',
                value = 'value',
                options = {};
